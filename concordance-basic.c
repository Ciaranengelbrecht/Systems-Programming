...
//  strdup() IS NOT A STANDARD C11 FUNCTION; WE NEED TO DECLARE IT UNDER LINUX
...
//  SKIP ALL NON-ALPHABETIC CHARACTERS, ENSURE WE DON'T GO PAST END OF STRING
...
//  OTHERWISE READ INPUT FROM STANDARD-INPUT STREAM (a pipe or redirected file)
    else {
